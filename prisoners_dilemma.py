...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
	...
	#
		...
		if getting_team_name:
			return 'Mazas,Andres and Le,Vinh'
		else:
	...
	#
		...
		if getting_team_name:
			return 'Reihuvenyoel,Etisoneescamilla'
		else:
			# use history, opponent_history, score, opponent_score
			# to compute your strategy
			if len(opponent_history)==0: #It's the first round: collude
	...
	#
		...
		if getting_team_name:
			return 'Bianca Bondoc, Transon Pho'
		else:
			 if len(opponent_history)==0: #It's the first round: collude
                		return 'c'
            		elif history[-1]=='c' and opponent_history[-1]=='b':
	...
	if getting_team_name:
		...
		if getting_team_name:
			return "ONYOKO!!!!!"
		elif !any("c" in opponent_history):
			return "b"
		elif !any("b" in opponent_history):
			return "b"
		elif any("cbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbc" in opponent_history):
			return "b"
		elif any("ccbccbccbccbccbccbccbccbccbccbccbccbccbccbccb" in opponent_history):
			return "b"
		elif any("bbcbbcbbcbbcbbcbbcbbcbbcbbcbbc" in opponent_history):
			return "b"
...
#Kevin Khoa Pho and Bryan Mijares: Dependencies
